...
#######<- readOGR(dsn='F:/R_script/SDM', layer="full")
...
############################# come back here if we need region names
...
# 
# distNa<-aggregate(distNa, fact=4, fun=mean, expand=TRUE, na.rm=TRUE)
...
# distMg.er<-aggregate(distMger, fact=4, fun=mean, expand=TRUE, na.rm=TRUE)
# 
...
# 
# distBa<-aggregate(distBa, fact=4, fun=mean, expand=TRUE, na.rm=TRUE)
# distBa.er<-aggregate(distBaer, fact=4, fun=mean, expand=TRUE, na.rm=TRUE)
# 
# distSr<-aggregate(distSr, fact=4, fun=mean, expand=TRUE, na.rm=TRUE)
# distSr.er<-aggregate(distSrer, fact=4, fun=mean, expand=TRUE, na.rm=TRUE)
# 
# distMn<-aggregate(distMn, fact=4, fun=mean, expand=TRUE, na.rm=TRUE)
# distMn.er<-aggregate(distMner, fact=4, fun=mean, expand=TRUE, na.rm=TRUE)
# 
...
# 
# 
# stk<-stack(distNa, distNaer.big, distMg.big, distMg.er, distP.big, distPer.big, distBa, distBa.er, distSr, distSr.er, distMn, distMn.er, distCu.big, distCuer.big) # make a raster stack form the above
# 
# 
...
# head(param)
# 
# image(distNa, main=' an example of one elements means')
...
# 
#   Na<-aggregate(Na, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
#  Na.er<-aggregate(Na.er, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
# # # 
#  Mg<-aggregate(Mg, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
#   Mg.er<-aggregate(Mg.er, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
# # # 
#   Ba<-aggregate(Ba, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
#   Ba.er<-aggregate(Ba.er, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
# # # 
#   Sr<-aggregate(Sr, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
#   Sr.er<-aggregate(Sr.er, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
# # # 
#   Mn<-aggregate(Mn, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
#   Mn.er<-aggregate(Mn.er, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
# # # 
...
# # # 
#   Rb<-aggregate(Rb, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
#   Rb.er<-aggregate(Rb.er, fact=2, fun=mean, expand=TRUE, na.rm=TRUE)
# # # 
