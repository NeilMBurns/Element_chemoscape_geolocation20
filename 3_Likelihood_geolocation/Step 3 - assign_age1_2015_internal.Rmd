...
#setwd("I:/Otolith_chem_paper/Elemental_maps")
...
## as before this ios really legacy code but required for later
...
This code allows geographic identification of the hauls but requires some background maps for context
OS boundary file of UK would do
```{r}
...
# 
# 
# sea.spdf<- readOGR(dsn="file path", layer="basic_sea")
# depth.sldf<- readOGR(dsn="Ffile path", layer="depth_area")
# 
