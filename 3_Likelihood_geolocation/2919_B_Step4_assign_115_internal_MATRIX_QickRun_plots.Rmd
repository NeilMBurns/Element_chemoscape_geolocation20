...
Ire <- gUnaryUnion(subset(landT, landT$COUNTRY_ID==3 | 
                            landT$COUNTRY_ID==7 | landT$COUNTRY_ID==8 | landT$COUNTRY_ID==10))
...
Na<- disaggregate(Na, fact=c(fac, round(fac/0.56)), method='bilinear')
Na.er<- disaggregate(Na.er, fact=c(fac, round(fac/0.56)), method='bilinear')
...
Mg<- disaggregate(Mg, fact=c(fac, round(fac/0.56)), method='bilinear')
Mg.er<- disaggregate(Mg.er, fact=c(fac, round(fac/0.56)), method='bilinear')
...
P<- disaggregate(P, fact=c(fac, round(fac/0.56)), method='bilinear')
P.er<- disaggregate(P.er, fact=c(fac, round(fac/0.56)), method='bilinear')
...
Ba<- disaggregate(Ba, fact=c(fac, round(fac/0.56)), method='bilinear')
Ba.er<- disaggregate(Ba.er, fact=c(fac, round(fac/0.56)), method='bilinear')
...
Sr<- disaggregate(Sr, fact=c(fac, round(fac/0.56)), method='bilinear')
Sr.er<- disaggregate(Sr.er, fact=c(fac, round(fac/0.56)), method='bilinear')
...
Mn<- disaggregate(Mn, fact=c(fac, round(fac/0.56)), method='bilinear')
Mn.er<- disaggregate(Mn.er, fact=c(fac, round(fac/0.56)), method='bilinear')
...
Zn<- disaggregate(Zn, fact=c(fac, round(fac/0.56)), method='bilinear')
Zn.er<- disaggregate(Zn.er, fact=c(fac, round(fac/0.56)), method='bilinear')
...
Rb<- disaggregate(Rb, fact=c(fac, round(fac/0.56)), method='bilinear')
Rb.er<- disaggregate(Rb.er, fact=c(fac, round(fac/0.56)), method='bilinear')
...
Li<- disaggregate(Li, fact=c(fac, round(fac/0.56)), method='bilinear')
Li.er<- disaggregate(Li.er, fact=c(fac, round(fac/0.56)), method='bilinear')
...
Sc<- disaggregate(Sc, fact=c(fac, round(fac/0.56)), method='bilinear')
Sc.er<- disaggregate(Sc.er, fact=c(fac, round(fac/0.56)), method='bilinear')
...
NM<- raster("S_Nminch117.grd")/20
NM <- disaggregate(NM, 10, method='bilinear')
Woff<- raster("S_Woff118.grd")/20
Woff <- disaggregate(Woff, 10, method='bilinear')

Cl<- raster("S_Clyde121.grd")/20
Cl <- disaggregate(Cl, 10, method='bilinear')

Jur<- raster("S_Jura122.grd")/20
Jur <- disaggregate(Jur, 10, method='bilinear')

SM<- raster("S_Sminch123.grd")/20
SM <- disaggregate(SM, 10, method='bilinear')

Off<- raster("S_Off124.grd")/20
Off <- disaggregate(Off, 10, method='bilinear')

EIS<- raster("S_EIS126.grd")/20
EIS <- disaggregate(EIS, 10, method='bilinear')

NNM<- raster("S_NNminch127.grd")/14
NNM <- disaggregate(NNM, 10, method='bilinear')

NEIS<- raster("S_NEIS135.grd")/17
NEIS <- disaggregate(NEIS, 10, method='bilinear')

WIS<- raster("S_WIS136.grd")/18
WIS <- disaggregate(WIS, 10, method='bilinear')
...
ices.ar<- readOGR(dsn='E:/Otolith_chem_paper/Elemental_maps/ices_areas', layer="ices_areas")
plot(ices.ar)
...
pdf(file="E:/Otolith_chem_paper/Comms_biology_paper/Figs/age1_catch_site_Vor.pdf",width=4, height=6)
par(mar=c(1,4,0,0)+0.1)
...
pdf(file="E:/Otolith_chem_paper/Comms_biology_paper/Figs/age1_catch_site_ices_ar.pdf",width=4, height=6)
